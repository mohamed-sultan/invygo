...
describe('FeaturedItem', () => {
  ...
  it('renders correctly', () => {
    const { UNSAFE_getByType } = render(
      <ThemeProvider>
        <FeaturedItem item={mockCar} onPress={mockOnPress} />
      </ThemeProvider>
    );
  ...
  it('displays car name with brand and year', () => {
    render(
      <ThemeProvider>
        <FeaturedItem item={mockCar} onPress={mockOnPress} />
      </ThemeProvider>
    ...
    const carName = titles.find((title) =>
      title.props.children.includes('Tesla Model 3 2023')
    );
  ...
  it('displays featured badge', () => {
    ...
    expect(screen.getByTestId('badge-topLeft-featured')).toBeTruthy();
  });
  ...
  it('does not display NEW badge when condition is not NEW', () => {
    ...
    render(
      <ThemeProvider>
        <FeaturedItem item={usedCar} onPress={mockOnPress} />
      </ThemeProvider>
    );
